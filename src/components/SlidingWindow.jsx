...
import cinema from '../assets/movies/cinema.jpg'; // Import the background image
              ...
              <div className="z-20 absolute bottom-12 left-40 text-white">          
                <div className="flex flex-col">
                  ...
                  <div className="flex my-4 gap-8">
                    <div className="bg-blue-600 text-white flex rounded p-3 gap-1 items-center cursor-pointer hover:bg-blue-700 transition-colors">
